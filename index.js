...
const DEFAULT_HOST = "url-shortner.spicydevs.repl.co";
const DEFAULT_BASE = "https://URL-Shortner.spicydevs.repl.co";
...
body { 
background-image: url(https://cdn.aayush.is-a.dev/pexels-mohamed-almari-1485894.jpg);
...
const htmlend = `
<footer><hr>
<subtitle style="font-size:0.8rem;color:darkgray">Similar Services <a href="${DEFAULT_BASE}">codez.ml</a> | <a href="https://spicydevs.me">dcbot.ml</a> | <a href="https://github.com/spicydevs">getcodes.ml</a>
<br>
</subtitle>
<subtitle style="font-size:0.8rem;color:darkgray">SpicyDevs <a href="${DEFAULT_BASE}">Home</a> | <a href="https://spicydevs.me">SpicyDevs</a> | <a href="https://github.com/spicydevs">Github</a>
</subtitle></footer>
</div>
</body>
`
...
app.get("/", async (req, res) => {
  ...
  res.end(`
      ${htmlhead}
      <div>
      <b class="indextitle">URL Shortner</b><br/>
...
<option value="https://getcodes.ml" disabled>https://getcodes.ml</option>
      ...
      <br>-->
      <a href="#">Currently serving ${num} URLs.</a>
  ` + htmlend)
